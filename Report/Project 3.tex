...
To improve convergence, we use a first-order optimization (either Adam or RMSProp, depending on tests) with a second-order quasi-Newton method (L-BFGS). 832498173498327489237492
